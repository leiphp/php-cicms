...
<div class="col-tab">
	<div id="div_setting_1" class="contentList pad-10">
		...
		<tr>
				<th>外部链接：</th>
				<td><input type="text" name="info[url]" id="url" class="input-text" value="" size="50"><span style="color: #fff;background: #d76161;padding: 5px 10px;border-radius: 4px;">只针对外部链接模型有效</span></td>
			  </tr>
			  <tr>
				<th>是否在导航显示：</th>
