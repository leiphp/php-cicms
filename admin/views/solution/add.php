...
<div class="nav10"></div>
<form name="myform" id="myform" action="<?=base_url();?>index.php/solution/add" method="post" enctype="multipart/form-data" />
<h2 id="tab_setting_1" class="on" onclick="switchmodTag('tab_setting_','div_setting_','1');this.blur();">添加内容</h2>
<div class="col-tab">
