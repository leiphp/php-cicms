...
<?php if(!empty($data['list'])){ foreach ($data['list'] as $v){?>
 ...
 <?php }}else{?>
	...
	<?php } ?> 
     ...
     <div class="btn">
		 <a class="button ulr"><i></i><input type="button" class="" value="百度url提交" onclick="myform.action='<?=base_url();?>index.php/common/baidu_url/news/';myform.submit();"/></a>
		 <a class="button sorting"><i></i><input type="button" class="" value="排序" onclick="myform.action='<?=base_url();?>index.php/news/order';myform.submit();"/></a>
