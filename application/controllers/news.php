...
class News extends MY_Controller{
	...
	public function lists(){
		...
		/*手机端响应式处理*/
		$w_style=$_GET['b'];
		$tp=auto_tp($tp,'wap/wap_news_list',$w_style);
		/*手机端响应式结束*/
		if($tp=='wap/wap_news_list'){$GLOBALS['wl_page']['news']=10;}
		...
		$page_list = config_page($count,$this->model.'/lists/'.$pagecatid,$GLOBALS['wl_page']['news']);
	...
	public function show(){
		...
		/*手机端响应式处理*/
		$w_style=$_GET['b'];
		$tp=auto_tp($tp,'wap/wap_news_show',$w_style);
		/*手机端响应式结束*/
