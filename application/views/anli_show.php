...
<div class="page_main">
  <div class="main">
      <div class="news_de_left grid_90 floatL mb30">
        ...
        <div class="text_info textL mt10 pb05 assist text_14">
          <span class="pr30"><img class="floatL mr05" src="skin/images/icon6.jpg"><?=date('Y/m/d',$data['res']['uptime'])?></span>
        </div>
        <div class="clear"></div>
        <div class="page_text">
        <?=$data['res']['content']?>
  ...
  <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
      ...
      <div class="news_de_r floatR grid_24">
        <h2 class="Slim mb15 text_18" style=" margin-bottom: 20px; padding-bottom: 10px;">案例推荐</h2>
        <ul>
        <?php foreach($this->p->get_list(6,$top_category['tablename']) as $v){ ?>
          <li>
            <div class="box grid_11 floatL"><a href="anli/show/<?=$v['id']?>.html"><img class="img" src="<?=$v['image']?>"></a></div>
            <div class="text floatR"><a href="anli/show/<?=$v['id']?>.html"><?=$v['title']?></a><span><?=date('Y-m-d',$v['uptime'])?></span></div>
          </li>
        <?php }?> 
        </ul>
      </div>
