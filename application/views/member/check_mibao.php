...
<form name="myform" id="myform" action="<?=base_url();?>member/reset_mibao/ask/" method="post">
...
<table width="100%" class="table_form ">
      <tr>
        <th width="100">问题1：</th>
        <td><?=$data['user_mibao']['mibao_ques']['ques1']?></td>
      </tr>
   <tr>
        <th>答案一：</th>
        <td>
 ...
 <tr>
        <th width="100">问题2：</th>
        <td><?=$data['user_mibao']['mibao_ques']['ques2']?>
